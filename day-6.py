#encapsulation means wrappin variables and methods together inside a class and controlling access of the data#
...
###abstractions###
#abstraction means hiding internal implementation and showing only necessary feature to the use##
